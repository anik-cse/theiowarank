        ...
        <div class="rounded shadow bg-white dark:bg-gray-800 dark:text-gray-900">
            <div class="p-4">
                ...
                <form action="{{ route('admin.slider.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mt-4">
                        <img src="https://via.placeholder.com/200x200?text=Placeholder+Image" id="image" style="width: 200; height: auto;">
                    </div>
                    <!-- image -->
                    <div class="mt-4">
                    ...
                    <div class="mt-4" x-cloak>
                        ...
                        <select
                            ...
                            <option value="{{ $animation->id }}" {{ old('animation_id') == $animation->id ? "selected" : "" }}>{{ $animation->title }}</option> 
                            @endforeach
                        </select>
