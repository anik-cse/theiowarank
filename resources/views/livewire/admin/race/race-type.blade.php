...
<div class="py-10 px-4">
    <div class="rounded shadow bg-white dark:bg-gray-800 dark:text-gray-900">
        <div class="w-full px-2 py-2 flex items-center justify-between">
            <h3 class="text-2xl font-bold dark:text-gray-100">Race Types</h3>
            ...
            <div class="w-full overflow-hidden rounded-lg shadow">
                ...
                <table class="table-fixed w-full">
                    ...
                    <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                        <th class="w-2/8 px-4 py-3">Race Type</th>
                    ...
                    <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                        <td class="px-4 py-3">
                            <p class="font-semibold">{{ $type->type_name }}</p>
                        </td>
     ...
     <x-jet-dialog-modal wire:model="modalFormVisible">
        ...
        <x-slot name="content">
            <div class="mt-4">
                <x-jet-label for="type_name" value="{{ __('Race Type') }}" />
                <x-jet-input id="type_name" class="block mt-1 w-full" type="text" wire:model.debounce.800ms="type_name" />
                @error('type_name') <span class="text-red-400">{{ $message }}</span> @enderror
            </div>
        </x-slot>
