                ...
                <tbody>
                    ...
                    <tr>
                        <td class="py-4">
                            ...
                            <p class="text-xs font-bold">{{ $item->city }}, {{ $item->region }}, {{ $item->iso }}</p>
                        </td>
                        <td class="py-4 pl-4">
        ...
        <div class="md:col-start-4 md:col-end-8 md:px-6 md:border-l-4 md:border-slate-900">
            ...
            <div class="col-span-12 sm:col-span-12 py-4">
                ...
                class="select-single">
                    ...
                    <option value="{{ $country->id }}" {{ $country->id == $this->country ? 'selected' : ''}}>{{ $country->name }}</option>
                    @endforeach
                </x-select>
            ...
            <x-button class="mt-2 bg-purple-500 hover:bg-purple-400" wire:click="update">
                {{ __('Save') }}
            </x-button>
        </div>
